...
abstract class AbstractMessageFragment extends Fragment with OnItemClickListener with OnItemLongClickListener {
  ...
  override def onCreateView(inflater: LayoutInflater, container: ViewGroup, savedInstanceState: Bundle): View = {
    ...
    contactsListView = rootView.findViewById(R.id.list_message_list).asInstanceOf[ListView]
